...
var tabServerController = /** @class */ (function () {
    ...
    tabServerController.prototype.eventSync = function (el, _el) {
        if (_el) {
            ...
            var parentAdd = _.difference(parents, _parents), parentDelete = _.difference(_parents, parents); parentAdd.concat(parentDelete); var childrenDifference = {};
...
var ObjectId$3 = mongoose.Schema.Types.ObjectId;
var tabUnitSchema = {
    title: String,
...
function TabUnitModel(unitName, unitSchema, unitStatics) {
    ...
    var UnitSchema = new mongoose.Schema(schema, { timestamps: true });
    UnitSchema.statics = statics;
    return mongoose.model(unitName, UnitSchema);
}

var ObjectId$2 = Schema.Types.ObjectId;
...
var ObjectId$1 = Schema.Types.ObjectId;
